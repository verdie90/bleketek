...
// Statement Document 2 interface
interface SuratPernyataan2 {
  id: string;
  // Document Details
  nomorSurat: string;
  tanggalSurat: string;
...
export default function SuratPernyataan2Page() {
  const [documents, setDocuments] = useState<SuratPernyataan2[]>([]);
  ...
  const [selectedDocument, setSelectedDocument] =
    useState<SuratPernyataan2 | null>(null);
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      ...
      try {
        const q = query(
          collection(db, "surat_pernyataan_2"),
          orderBy("createdAt", "desc")
        );

        const unsubscribe = onSnapshot(q, (querySnapshot) => {
          const documentsData: SuratPernyataan2[] = [];
  ...
  const generateDocumentNumber = () => {
    ...
    return `SP2/${String(count).padStart(3, "0")}/${month}/${year}`;
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editingId) {
        ...
        await updateDoc(doc(db, "surat_pernyataan_2", editingId), documentData);
        toast.success("Surat pernyataan berhasil diperbarui");
      } else {
        // Create new document
        await addDoc(collection(db, "surat_pernyataan_2"), {
          ...documentData,
  ...
  const handleEdit = (document: SuratPernyataan2) => {
  ...
  const handleDelete = async (documentId: string) => {
    if (
      ...
      try {
        await deleteDoc(doc(db, "surat_pernyataan_2", documentId));
  ...
  const handleViewDetails = (document: SuratPernyataan2) => {
  ...
  const generatePDF = (document: SuratPernyataan2) => {
    const doc = new jsPDF();
    ...
    doc.save(
      `surat-pernyataan-2-${document.nomorSurat.replace(/\//g, "-")}.pdf`
    );
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Surat Pernyataan 2</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="max-w-7xl mx-auto w-full">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 mt-2">
                    Kelola dokumen surat pernyataan tipe 2 untuk klien
                  </p>
                </div>
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                      <DialogHeader>
                        <DialogTitle>
                          {editingId ? "Edit" : "Buat"} Surat Pernyataan 2
                        </DialogTitle>
                        <DialogDescription>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Daftar Surat Pernyataan 2</CardTitle>
                <CardDescription>
                  Kelola semua dokumen surat pernyataan tipe 2
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoading ? (
        ...
        <Dialog open={isDetailModalOpen} onOpenChange={setIsDetailModalOpen}>
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Detail Surat Pernyataan 2</DialogTitle>
              <DialogDescription>
