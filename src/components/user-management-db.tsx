...
import {
  ...
  User,
  UserActivity,
} from "@/hooks/use-user-management-db";
import { useRoles } from "@/hooks/use-roles";
import RoleInitializer from "./role-initializer";
import SystemInitializer from "./system-initializer";

export default function UserManagementDB() {
  // User Management Hook (Database only)
  const {
    users,
    userActivities,
    loading,
  ...
  const handleShowPasswordReset = (user: User) => {
    setSelectedUser(user);
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold tracking-tight">User Management</h2>
          <p className="text-muted-foreground">
            Manage user accounts, roles, and permissions (Database Only)
          </p>
        </div>
        <div className="flex items-center space-x-2">
                      ...
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuItem
                              onClick={() => handleShowPasswordReset(user)}
                            >
